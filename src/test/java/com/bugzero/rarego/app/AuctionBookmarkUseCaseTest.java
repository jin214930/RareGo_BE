...
class AuctionBookmarkUseCaseTest {
    ...
    void addBookmark_Success() {
        ...
        // when
        AuctionAddBookmarkResponseDto result = auctionBookmarkUseCase.addBookmark(publicId, auctionId);
    ...
    void removeBookmark_Success() {
        ...
        // when
        AuctionRemoveBookmarkResponseDto result = auctionBookmarkUseCase.removeBookmark(publicId, auctionId);
