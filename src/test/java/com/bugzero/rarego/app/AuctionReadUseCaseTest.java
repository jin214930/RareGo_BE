...
class AuctionReadUseCaseTest {
    ...
    void getAuctions_with_search_condition() {
        ...
        ReflectionTestUtils.setField(condition, "category", Category.valueOf("스타워즈"));
        Pageable pageable = PageRequest.of(0, 10);

        // 1. 키워드로 상품 ID 검색
        given(productApiClient.searchProductIds("키워드", Category.valueOf("스타워즈"))).willReturn(List.of(productId));
