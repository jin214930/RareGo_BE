...
class AuctionReadUseCaseTest {
    ...
    void getAuctions_with_search_condition() {
        ...
        // 1. 키워드로 상품 ID 검색
        given(productApiClient.searchProductIds("키워드", Category.STARWARS)).willReturn(List.of(productId));
        ...
        verify(productApiClient).searchProductIds("키워드", Category.STARWARS);
